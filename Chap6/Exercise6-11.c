/*
 * Exercise 6-11 - Implement the Sieve of Eratosthenes algorithm from chapter 5.
 * Replace the broadcast step with a pipeline of sends and recieves.
 */
// Compile with mpicc -o Exercise6-11 Exercise6-11.c -lm
