...
/*
 *
 * Exercise 5-8. Modify the original Sieve algorithm to incorporate all three
 * improvements from the text. The third and final improvement is to
 * reorganizing the loops.
 */
...
//			printf("low_primes[i]: %d, i: %d\n",low_primes[i],i);
	...
	int local_primes[local_prime_count];
