...
// mpirun -np 2 ./Exercise5-6Try2 200, 101 will be checked by process 0 and 1
// Appears to be fixed by adding a check in the for loop actually doing the sieving
